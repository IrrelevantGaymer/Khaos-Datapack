...
tellraw @a[team=khaos.mafia] [{"text":"Your Consort, "}{"selector":"@s"},{"text":", died"}]
...
execute if score EvilRoles khaos.var matches 0 run khaos:game_state_handling/win_condition/town_win_condition
